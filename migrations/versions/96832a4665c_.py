...
Revision ID: 96832a4665c
Revises: None
Create Date: 2017-11-05 20:58:07.527004

"""

# revision identifiers, used by Alembic.
revision = '96832a4665c'
down_revision = None
...
def upgrade():
    ...
    op.create_table('lide',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('jmeno', sa.String(), nullable=False),
    sa.Column('prijmeni', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('id', name='pk_lide'),
    sqlite_autoincrement=True
    )
    op.create_index('ix_lide_id', 'lide', ['id'], unique=False)
    ...
    op.create_table('pokuty',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('idPokutovaneho', sa.Integer(), nullable=False),
    sa.Column('duvod', sa.String(), nullable=False),
    sa.Column('castka', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['idPokutovaneho'], ['lide.id'], name='fk_pokuty_idPokutovaneho_lide'),
    sa.PrimaryKeyConstraint('id', name='pk_pokuty'),
    sqlite_autoincrement=True
    )
...
def downgrade():
    ...
    op.drop_index('ix_lide_id', table_name='lide')
    op.drop_table('lide')
    ### end Alembic commands ###
